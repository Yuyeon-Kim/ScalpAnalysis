...
def fancy_pca(img, alpha_std=0.1):
    ...
    Where pi and ��i are ith eigenvector and eigenvalue of the 3 �� 3 covariance
    matrix of RGB pixel values, respectively, and ��i is the aforementioned
    random variable. Each ��i is drawn only once for all the pixels of a
